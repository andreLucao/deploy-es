...
export default function Produtos({ produtos, produtosPorPagina = 10, modoVisualizacao }: ProdutosProps) {
  ...
  return (
    <div className="flex flex-col justify-items-center items-center w-full">
      ...
      <div 
        ...
        style={{
          display: 'grid',
          gridTemplateColumns: modoVisualizacao === 'grid' 
            ? 'repeat(4, 1fr)' 
            : '1fr',
      ...
      >
        {produtosPagina.map((produto) => (
          ...
          >
            <div 
              className={modoVisualizacao === 'grid' ? "text-center" : "flex-1"}
              style={{
