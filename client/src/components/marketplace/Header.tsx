...
export default function Header() {
   ...
   return (
      <>
         <div className="w-full h-16 sm:h-20 flex items-center px-4 sm:px-8 lg:px-24 py-3 sm:py-5 bg-[#002E34] bg-opacity-50 rounded-b-xl relative z-50 sticky top-0">
            {/* Logo */}
