...
useEffect(() => {
  ...
  return () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row h-full justify-center items-center gap-3 sm:gap-6 lg:gap-8 py-4 px-4">
            {/* Ordenação */}
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                <p className="text-xs sm:text-sm whitespace-nowrap">Ordenar por:</p>
                <div className="relative flex-1 sm:flex-none">
                    <select
                        ...
                        className="appearance-none w-full bg-white border border-gray-300 rounded-lg px-3 py-2 pr-8 text-xs sm:text-sm cursor-pointer 
            ...
            <div className="relative w-full sm:w-auto">
                <input
                    ...
                    className="bg-white text-black placeholder-black border border-gray-300 rounded-lg pl-3 pr-10 py-2 text-xs sm:text-sm 
                               focus:outline-none focus:ring-2 focus:ring-[#008f70] 
                               focus:border-transparent transition-all duration-200 shadow-sm hover:shadow-md w-full sm:w-[180px]"
                />
...
<div className="flex justify-end gap-2 mt-4">
  ...
  >
    Aplicar
            ...
            {/* Modo de Visualização e Produtos por Página */}
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 lg:gap-6 w-full sm:w-auto">
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                        <p className="text-xs sm:text-sm whitespace-nowrap">Nº Produtos / Página:</p>
                        <div className="relative flex-1 sm:flex-none">
                            <select 
                                value={produtosPorPagina} 
                                onChange={(e) => setProdutosPorPagina(Number(e.target.value))}
                                className="appearance-none w-full bg-white border border-gray-300 rounded-lg px-3 py-2 pr-6 text-xs sm:text-sm cursor-pointer hover:border-[#008f70] focus:outline-none focus:ring-2 focus:ring-[#008f70] focus:border-transparent transition-all duration-200 shadow-sm hover:shadow-md"
                            >
