...
export default function CommentsSection({ adProductId }: CommentsSectionProps) {
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                setLoading(true);
                const response = await fetch(`http://localhost:3001/api/comments/get-ad-comments?adProductId=${adProductId}`);
    ...
    const handleLikeComment = async (commentId: string) => {
        try {
            ...
            if (existingLike) {
                ...
                response = await fetch('http://localhost:3001/api/comments/unlike-comment', {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                response = await fetch('http://localhost:3001/api/comments/like-comment', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
